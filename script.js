    ...
    $.fn.puissance4 = function () {
        class Puissance4 {
            constructor(selector) {
                ...
                $("body").append("<br><div class='btn'><input id='x' value='6'><input value='7' id='y'><button type='submit' id='go'>Choisir la taille</button></div>");
                $("body").append("<br><div class='btn'><input id='x' value='blue'><button type='submit' id='go'>Choisir la couleur</button></div>");
                $("body").append("<br><div class='btn'><input id='x' value='Joueur RED'><button type='submit' id='go'>Pseudo joueur 1</button></div>");
                $("body").append("<br><div class='btn'><input id='x' value='Joueur YELLOW'><button type='submit' id='go'>Pseudo joueur 2</button></div>");
            ...
            grille() {
                ...
                $("body").prepend("<h3 class='play'><span id='player'>Joueur RED à toi !</span></h3>");
                $("body").prepend("<div class='result'><div class='scorered'><p> Joueur RED: <span class='countRed'>0</span></p></div> <div class='secoreyellow'><p>Joueur YELLOW: <span class='countYellow'>0</span></p></div></div>");
            ...
            placerPions() {
                ...
                grille.on('click', '.col.empty', function () {
                    ...
                    if (winner) {
                        const that = this;
                        that.victoire = true;
                        $('#win').text('VICTOIRE !! ' + clr.toUpperCase() + ' A GAGNE ... ');
